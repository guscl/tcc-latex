...
\includegraphics[keepaspectratio=true,scale=0.60]
{figuras/weights.eps}
\caption{Equação de Atualização de Pesos - \citeonline{somaijk}}
\label{data_titatic}
\end{figure}
...
\caption{Equação do Fator de Aprendizagem - \citeonline{somaijk}}
\label{data_titatic}
\end{figure}
...
\caption{Influência da Distância com o Vencedor - \citeonline{somaijk}}
\label{data_titatic}
\end{figure}
